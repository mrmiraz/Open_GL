...
void drawXAxisArrow(int sign){
    glColor3f(0, 0,0);
    glBegin(GL_TRIANGLES);
    glVertex3f(0,-3, -10);
    glVertex3f(0, 3, -10);
    glVertex3f(sign*3, 0, -10);
    glEnd();
}

void drawYAxisArrow(int sign){
    glColor3f(0, 0,0);
    glBegin(GL_TRIANGLES);
    glVertex3f(3,0, -10);
    glVertex3f(-3, 0, -10);
    glVertex3f(0, sign*3, -10);
    glEnd();
}
...
void display(){
	...
	****************************/
    ...
    // left ball
    glTranslatef(x,0,0);
    flag == 0? drawXAxisArrow(1):drawXAxisArrow(-1);
    glColor3f(1,1,0);
    drawSphere(10,24,80);
    glTranslatef(-x,0,0);
    ...
    //up ball
    glTranslatef(0,x,0);
    flag == 0? drawYAxisArrow(1):drawYAxisArrow(-1);
    glColor3f(1,0,0);
    drawSphere(10,24,80);
    glTranslatef(0,-x,0);
